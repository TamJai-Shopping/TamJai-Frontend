<template>
  <div class="font-mono mx-auto max-w-7xl text-gray-700">
    <h1 class="pl-8 pt-6 text-xl ml-14">หมวดหมู่สินค้า</h1>
      ...
      <div class="pl-8 flex my-4">
        <div class="flex items-center justify-center">
          <div>
            ...
            <input id="start_price" v-model="priceRange.start" class="rounded-lg shadow w-32 bg-gray-100 border-gray-200 py-2" min="0"
                   type="number">
          </div>
          <p class="mx-4">-</p>
          <div>
            <input id="end_price" v-model="priceRange.end" class="rounded-lg shadow w-32 bg-gray-100 border-gray-200 py-2" min="0"
                   type="number">
          </div>
          <div class="mx-2 flex inset-y-0 left-0 items-center pl-3 cursor-pointer">
            <button class="p-2.5 bg-[#528D58] border shadow rounded-lg" @click="priceFilter()">
