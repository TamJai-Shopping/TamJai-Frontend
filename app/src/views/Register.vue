<template>
    <section>
<<<<<<< HEAD:app/src/views/Register.vue
...
=======
        <form @submit.prevent="saveNewUser()" class="flex flex-col items-center my-10 font-mono px-10 py-8 mx-auto md:h-screen lg:py-0">
            <RouterLink to="/" class="mx-20 text-center mb-6 text-2xl text-[#528D58] font-bold">
                TamJai Shopping    
            </RouterLink>
            <div v-if="error">
...
>>>>>>> origin/develop:app/src/views/SignUpView.vue
