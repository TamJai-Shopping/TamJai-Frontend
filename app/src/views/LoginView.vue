<template>
    <section>
        <form @submit.prevent="onFormSubmit()"
            class="flex flex-col items-center justify-center font-mono px-6 py-8 mx-auto md:h-screen lg:py-0">
                    ...
                    <div class="space-y-4 md:space-y-6">
                        ...
                        <div>
                            ...
                            <input type="email" name="email" id="email" v-model="email" required autocomplete="off"
                                class="bg-white border border-white shadow text-gray-900 sm:text-sm rounded-lg block w-full p-2.5 "
                                placeholder="">
                        </div>
                        <div>
                            ...
                            <input type="password" name="password" id="password" placeholder="" v-model="password"
                                required
                                class="mb-2 bg-white border border-white shadow text-gray-900 sm:text-sm rounded-lg block w-full p-2.5">
                        </div>
                        <div>
                            <button type="submit"
                                class="w-full text-white mb-3 bg-[#B3BA1E] shadow hover:bg-[#aeb347] rounded-lg px-5 py-2.5 text-center">เข้าสู่ระบบ</button>
                            <p class="text-sm text-gray-600">
                                ยังไม่มีบัญชีใช่หรือไม่ <a href="/signup"
                                    class="text-base text-[#B3BA1E] hover:underline font-bold">สมัครบัญชี</a>
                            </p>
                        </div>
                    </div>
                </div>
