    ...
    <div class="lg:flex">
        ...
        <div class="flex-initial ml-60 w-full lg:max-h-full">
            <div class="font-mono mt-4 mx-20 overflow-x-auto relative">
                ...
                <img v-if="imageData.length == 0" class="rounded-lg mx-auto my-4" :src="this.$axios.defaults.baseURL + '/images/search?product_id=' + product.id" alt="image description" width="200" height="200">
            ...
            <div class="image-preview" v-if="imageData.length > 0">
                ...
                <div class="mx-auto w-5/6 my-4">
                    <label for="price">หมวดหมู่ (ถ้าหลายหมวดหมู่ให้ใส่ , คั่น)</label>
        
                    <input type="text" v-model="product.categories_str" class="mt-2 bg-[#F1F1F1] border-[#F1F1F1] text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                ...
                <div class="text-center mb-4">
                    ...
                    <button v-on:click="saveNewProduct()" class="m-2 text-center text-gray-700 bg-[#B0C03B] shadow hover:bg-[#aab03c] focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg  w-full sm:w-auto px-6 py-2.5">แก้ไขข้อมูล</button>
                </div>
            </div>
        </div>
    </div>
