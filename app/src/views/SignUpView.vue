                    ...
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        <div class="space-y-4 md:space-y-6">
                            ...
                            <div>
                                ...
                                <input type="email" name="email" id="email" class="bg-white border border-white shadow text-gray-900 sm:text-sm rounded-lg block w-full p-2.5 " placeholder="" required>
                            </div>
                            <div>
                                <label for="username" class="block mb-2 text-gray-900 dark:text-white">ชื่อผู้ใช้</label>
                                <input type="text" name="username" id="username" class="bg-white border border-white shadow text-gray-900 sm:text-sm rounded-lg block w-full p-2.5 " placeholder="" required>
                            </div><div>
                                <label for="tel" class="block mb-2 text-gray-900 dark:text-white">เบอร์โทรศัพท์</label>
                                <input type="tel" name="tel" id="tel" class="bg-white border border-white shadow text-gray-900 sm:text-sm rounded-lg block w-full p-2.5 " placeholder="" required>
                            </div>
                            <div>
                                <label for="password" class="block mb-2  text-gray-900 dark:text-white">รหัสผ่าน</label>
                                <input type="password" name="password" id="password" placeholder="" class="mb-2 bg-white border border-white shadow text-gray-900 sm:text-sm rounded-lg block w-full p-2.5" required>
                            </div>
                            <div>
                                <label for="confirm_password" class="block mb-2  text-gray-900 dark:text-white">ยืนยันรหัสผ่าน</label>
                                <input type="password" name="confirm_password" id="confirm_password" placeholder="" class="mb-2 bg-white border border-white shadow text-gray-900 sm:text-sm rounded-lg block w-full p-2.5" required>
                            </div>
                            <div>
